...
49) Пример разпределителя роутов
    const getIconContent = ({ tab, onSelect }: { tab: number, onSelect: (ev: React.SyntheticEvent) => void }) => {
      switch (tab) {
        case 1:
...
50) css - полукруг
    border-top: solid 0.9vmin transparent;
    border-left: solid 0.9vmin black;
    border-bottom: solid 0.2vmin transparent;
